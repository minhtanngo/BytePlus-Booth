...
THEMES: dict[str, dict[str, Any]] = {
    ...
    "neon-velocity": {
        ...
        "prompt": _p(
            ...
            "single driver is person [Image 1], wearing a black racing jacket with cyan "
            "trim. Motion-blur the environment but keep the face sharp and "
            "clearly lit. "
            "Shot 1 (0-5s): clean close-up of person [Image 1] behind the wheel of a "
            ...
            "Shot 3 (10-15s): cut back to a clear close-up of person [Image 1] with a "
    ...
    "orbital-summit": {
        ...
        "prompt": _p(
            ...
            "Shot 1 (0-5s): Person [Image 1] walks confidently across a curved glass "
            "deck; through the window behind, Earth turns slowly in space. "
            "Shot 2 (5-10s): Person [Image 1] raises a hand and glowing holographic "
            "charts and a rotating globe bloom in the air; clear close-up of "
            "[Image 1]'s face lit blue by the holograms. "
            "Shot 3 (10-15s): low-angle hero shot of Person [Image 1] standing tall "
    ...
    "stormbreaker": {
        ...
        "prompt": _p(
            ...
            "warrior is person [Image 1], in a green-and-black checkered haori, holding "
            "a katana in a misty moonlit forest. "
            "Shot 1 (0-5s): Person [Image 1] lowers into a stance, both hands on the "
            "hilt; as the blade draws, a giant blue water dragon spirals around "
            "the warrior, roaring with rushing water. "
            "Shot 2 (5-10s): Person [Image 1] dashes forward in a streak of golden "
            "lightning between the trees; quick clear close-up of [Image 1]'s "
            "focused face. "
            "Shot 3 (10-15s): Person [Image 1] swings the blade down — water dragon and "
    ...
    "festival-of-light": {
        ...
        "prompt": _p(
            ...
            "golden-amber and crimson tones, 15 seconds. The person"
            "[Image 1], in elegant festive attire at an old riverside town at "
            "night strung with glowing lanterns. "
            "Shot 1 (0-5s): warm shot gliding toward person [Image 1] on a stone bridge "
